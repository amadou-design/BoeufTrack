...
app.post('/analyze', async (req, res) => {
  try {
    ...
    const response = await fetch('https://api.anthropic.com/v1/messages', {
      ...
      body: JSON.stringify({ model: 'claude-opus-4-5', max_tokens: 300, messages: [{ role: 'user', content: [{ type: 'image', source: { type: 'base64', media_type: 'image/jpeg', data: image_b64 } }, { type: 'text', text: prompt }] }] })
    });
...
app.listen(process.env.PORT || 3000, () => console.log('BoeufTrack API running'));
